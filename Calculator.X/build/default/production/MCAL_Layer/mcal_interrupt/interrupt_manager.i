# 1 "MCAL_Layer/mcal_interrupt/interrupt_manager.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "MCAL_Layer/mcal_interrupt/interrupt_manager.c" 2
...
# 1 "MCAL_Layer/mcal_interrupt/interrupt_manager.h" 1
# 12 "MCAL_Layer/mcal_interrupt/interrupt_manager.h"
...
# 12 "MCAL_Layer/mcal_interrupt/interrupt_manager.h" 2
...
void INT0_ISR(void);
void INT1_ISR(void);
# 8 "MCAL_Layer/mcal_interrupt/interrupt_manager.c" 2
# 29 "MCAL_Layer/mcal_interrupt/interrupt_manager.c"
void __attribute__((picinterrupt(("")))) InterruptMananger(void)
{

    if(((1) == INTCONbits.INT0IE)&&(((1) == INTCONbits.INT0F)))
    {
        INT0_ISR();
    }
    else{ }
    if(((1) == INTCON3bits.INT1IE)&&(((1) == INTCON3bits.INT1F)))
    {
        INT1_ISR();
    }
    else{ }
