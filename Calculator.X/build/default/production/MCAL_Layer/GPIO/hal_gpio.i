...
# 22 "MCAL_Layer/GPIO/../mcal_std_types.h"
...
# 77 "MCAL_Layer/GPIO/../mcal_std_types.h"
...
# 1 "MCAL_Layer/GPIO/../../CommonMacros.h" 1
...
Std_ReturnType GPIO_pin_dir_init(const Pin_config_t * _pin_cfg)
{
    ...
    if((((void*)0)!=_pin_cfg)&&(_pin_cfg->Pin < ((8)))&&(_pin_cfg->Port < ((5))))
    {
        ret=((Std_ReturnType)0X01);
        switch(_pin_cfg->Direction)
        {
            case GPIO_Output:
                (*tris_registers[_pin_cfg->Port]&=~(1<<_pin_cfg->Pin));
...
{
    Std_ReturnType ret = ((Std_ReturnType)0X00);
    if((((void*)0)!=_pin_cfg)&&(_pin_cfg->Pin < ((8)))&&(_pin_cfg->Port < ((5)))&&(((void*)0)!=Dir))
    {
        ret=((Std_ReturnType)0X01);
        *Dir=((*tris_registers[_pin_cfg->Port] >> _pin_cfg->Pin) & 1);
    }
    return ret;
}
# 99 "MCAL_Layer/GPIO/hal_gpio.c"
Std_ReturnType GPIO_pin_write(const Pin_config_t * _pin_cfg,Logic_t logic)
{
    Std_ReturnType ret = ((Std_ReturnType)0X00);
    if((((void*)0)!=_pin_cfg)&&(_pin_cfg->Pin < ((8)))&&(_pin_cfg->Port < ((5))))
    {
        ...
        {
            case GPIO_LOW:
                (*lat_registers[_pin_cfg->Port]&=~(1<<_pin_cfg->Pin));
                break;
            case GPIO_HIGH:
                (*lat_registers[_pin_cfg->Port]|=(1<<_pin_cfg->Pin));
                break;
...
{
    Std_ReturnType ret = ((Std_ReturnType)0X00);
    if((((void*)0)!=_pin_cfg)&&(_pin_cfg->Pin < ((8)))&&(_pin_cfg->Port < ((5)))&&(((void*)0)!=logic))
    {
        *logic=((*port_registers[_pin_cfg->Port] >> _pin_cfg->Pin) & 1);
        ret=((Std_ReturnType)0X01);
    }
    return ret;
}
