# 1 "Calculator_Math/CalculatorMath.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "Calculator_Math/CalculatorMath.c" 2
# 10 "Calculator_Math/CalculatorMath.c"
# 1 "Calculator_Math/CalculatorMath.h" 1
# 11 "Calculator_Math/CalculatorMath.h"
# 1 "Calculator_Math/../MCAL_Layer/mcal_std_types.h" 1
# 12 "Calculator_Math/../MCAL_Layer/mcal_std_types.h"
# 1 "Calculator_Math/../MCAL_Layer/std_libraries.h" 1
# 12 "Calculator_Math/../MCAL_Layer/std_libraries.h"
...
# 12 "Calculator_Math/../MCAL_Layer/std_libraries.h" 2
...
# 13 "Calculator_Math/../MCAL_Layer/std_libraries.h" 2
...
# 14 "Calculator_Math/../MCAL_Layer/std_libraries.h" 2
...
# 15 "Calculator_Math/../MCAL_Layer/std_libraries.h" 2

# 1 "C:\\Program Files\\Microchip\\xc8\\v2.40\\pic\\include\\c99\\stdbool.h" 1 3
# 16 "Calculator_Math/../MCAL_Layer/std_libraries.h" 2
# 12 "Calculator_Math/../MCAL_Layer/mcal_std_types.h" 2

# 1 "Calculator_Math/../MCAL_Layer/compiler.h" 1
# 12 "Calculator_Math/../MCAL_Layer/compiler.h"
...
# 12 "Calculator_Math/../MCAL_Layer/compiler.h" 2
# 13 "Calculator_Math/../MCAL_Layer/mcal_std_types.h" 2
# 22 "Calculator_Math/../MCAL_Layer/mcal_std_types.h"
...
# 77 "Calculator_Math/../MCAL_Layer/mcal_std_types.h"
typedef uint8 Std_ReturnType;
# 11 "Calculator_Math/CalculatorMath.h" 2
...
# 10 "Calculator_Math/CalculatorMath.c" 2
# 21 "Calculator_Math/CalculatorMath.c"
static _Bool is_num(char x);
...
# 54 "Calculator_Math/CalculatorMath.c"
float32 HandleString(char * str){

    char prev_char = 0;

    unsigned char numberCaught = (0);
...
# 167 "Calculator_Math/CalculatorMath.c"
_Bool SyntaxErr(char * str){
...
# 257 "Calculator_Math/CalculatorMath.c"
_Bool MathError(char * str){
    char *temp = str;
    while(*str){
        if(*str=='/'){
...
# 295 "Calculator_Math/CalculatorMath.c"
static _Bool is_num(char x){
    if((x >= '0') && (x <= '9')){
        return (1);
    }
...
# 309 "Calculator_Math/CalculatorMath.c"
static _Bool is_op(char x){
    if((x=='-')||(x=='+')||(x=='*')||(x=='/')){
        return (1);
    }
...
# 323 "Calculator_Math/CalculatorMath.c"
static _Bool is_power(char *x){
    char *temp = x;
    if(temp != ((void*)0)){
        if(*temp == '*'){
...
# 345 "Calculator_Math/CalculatorMath.c"
static float32 Calculate(float32 n1,float32 n2,char op){
    switch (op)
    {
    case '+':
